...
# from ray.rllib.algorithms.reinforce.reinforce_tf_policy import (
#     ReinforceTF1Policy,
#     ReinforceTF2Policy,
# )
# from ray.rllib.algorithms.reinforce.reinforce_torch_policy import ReinforceTorchPolicy
...
class ReinforceConfig(AlgorithmConfig):
    def __init__(self, algo_class=None):
        """Initializes a ReinforceConfig instance."""
...
class Reinforce(Algorithm):
    ...
    def get_default_config(cls) -> AlgorithmConfigDict:
        return ReinforceConfig().to_dict()
    ...
    def get_default_policy_class(
        ...
        if config["framework"] == "torch":
            ...
            return ReinforceTF1Policy
        else:
            return ReinforceTF2Policy
...
# Deprecated: Use ray.rllib.algorithms.reinforce.reinforce.ReinforceConfig instead!
class _deprecated_default_config(dict):
    def __init__(self):
        super().__init__(ReinforceConfig().to_dict())

    @Deprecated(
        old="ray.rllib.algorithms.dqn.reinforce::DEFAULT_CONFIG",
        new="ray.rllib.algorithms.reinforce.reinforce::ReinforceConfig(...)",
        error=False,
    )
